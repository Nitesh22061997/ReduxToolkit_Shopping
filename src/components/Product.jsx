        ...
        <div>
            ...
            <div className='container'>
                <div className="row">
                    {
                        Products.map((item) => (
                            <div key={item.id} className='container col-md-6 col-lg-4 my-5'>
                                <div className="card bg-dark" style={{ width: "18rem" }}>
                                    <div className='p-3 d-flex justify-content-center align-items-center'>
                                        <img src={item.imgSrc} className="card-img-top" alt="image" style={{ width: "200px", height: "200px", borderRadius: "10px" }} />
                                    </div>
